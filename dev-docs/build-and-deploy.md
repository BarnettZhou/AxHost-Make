...
│       └── js/
│           ├── icons.js        # 从 client/js/icons.js 复制
...
│   └── resources/              # 项目资源
│       ├── flowchart/          # 流程图 UI（flowchart.js + .css）
│       └── js/mermaid.min.js   # 条件性复制（有流程图时）
...
**输入：** `client/preview-index.html` + `client/css/shell.css` + `client/js/icons.js` + `client/js/preview-app.js`  
**输出：** `templates/preview/index.html` + `templates/preview/resources/*`
...
| `/client/css/` | `./resources/css/` | CSS 资源本地化 |
| `/client/js/` | `./resources/js/` | JS 资源本地化 |
...
| `client/assets/marked.min.js` | `prototype/resources/js/marked.min.js` | 覆盖 |
| `client/assets/mermaid.min.js` → | `prototype/resources/js/mermaid.min.js` | 有流程图时复制，无则删除 |
| `client/js/icons.js` | `prototype/resources/js/icons.js` | 覆盖 |
| `client/css/shell.css` | `prototype/resources/css/shell.css` | 覆盖 |
| `client/js/preview-app.js` | `prototype/resources/js/preview-app.js` | 覆盖 |
