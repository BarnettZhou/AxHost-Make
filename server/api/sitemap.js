...
async function regenerateSitemap(projectRoot) {
  ...
  try {
    ...
    existingOrderMap = oldData.orderMap || existingOrderMap;
  } catch (e) {}
  ...
  const sitemap = { name: existingName, pages, components, orderMap: existingOrderMap, generatedBy: 'axhost-make' };
  await fs.writeFile(
    sitemapPath,
